...
4.  Negative `n` to `slice_min()`
    ...
    If I pass a negative number to the `n` option in `slice_min()`, it will arrange the data frame by carrier and give the whole arranged data frame as the output.
